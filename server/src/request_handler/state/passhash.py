...
# at no time does the server or client send or receive a plain text password.
...
# if client receives salt ask if this is new user. if no, return and restart login.
